...
import { companyResearchActivity, jobsFoundOverTime, matchScoreDistribution } from "@/lib/dashboard-placeholder";

type DashboardPageProps = { displayName: string; stats: DashboardStat[]; recentActivity: ActivityItem[] };
